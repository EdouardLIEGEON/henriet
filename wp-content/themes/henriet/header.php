...
<title>Henriet électricité</title>
    <nav class="navbar">
      <div class="container-fluid">
        <a class="navbar-brand" href="/henriet/"><img src="http://localhost/henriet/wp-content/uploads/2022/11/HENRIET-ELECTRICITE-Logovisto.png"></a>
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
          ...
          <div class="offcanvas-body">
            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
              <li class="nav-item">
                <a class="nav-link" aria-current="page" href="/henriet/">Accueil</a>
              </li>
              <li class="nav-item dropdown">
                ...
                <li class="nav-item">
                <a class="nav-link" href="/henriet/societe/">Notre société</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="/henriet/realisations/">Nos réalisations</a>
              </li>
              <li class="nav-item">
